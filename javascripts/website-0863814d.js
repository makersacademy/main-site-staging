...
/* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+bash+git+haml+haskell+java+python+jsx+ruby+scheme+smalltalk+swift+yaml&plugins=file-highlight */
...
var Baseliner = function(options) {
  ...
  var baseliner = this;
  this.overlay_id = this.opts.overlayId;
  this.overlay = null;
  ...
  this.create = function() {
    ...
    this.opts.gridHeight.forEach(function(lineSettings, index) {
      var gridHeight = lineSettings[0];
      var color = baselinerColor(lineSettings[1]);
      this.overlay = document.createElement('div');
      //this.overlay.id = this.overlay_id;
      this.overlay.className = 'overlay-element';
      document.body.appendChild(this.overlay);
      this.overlay.style.background =  'url(http://baselinebg.keyes.ie/?h=' + gridHeight + '&r=' + color[0] + '&g=' + color[1] + '&b=' + color[2] + '&s=' + this.opts.gridSpace + ') repeat';
  ...
  this.toggle = function(forced) {
    if (true || forced) {
      ...
      //}
      var elements = document.getElementsByClassName('overlay-element');
